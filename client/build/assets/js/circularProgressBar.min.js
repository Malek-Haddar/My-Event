  ...
  return function t(i) {
    ...
    !(function (e, t) {
      ...
      e(this, "initial", function (e) {
              ...
              function (e, n) {
                e.forEach(function (e) {
                  e.isIntersecting &&
                    ...
                    (o.createSvg(e.target, t), n.unobserve(e.target), t++);
                });
              },
        ...
        } else for (var r = 0; r < e.length; r++) o.createSvg(e[r], r);
      }),
      ...
      e(this, "progressBar", function (e, t, r) {
        ...
        var g = document.querySelector(
            ".".concat(o.pieName, "-circle-").concat(i)
          ),
          h = {
            fill: "none",
        ...
        o.setAttr(g, h, !1),
          o.animationTo(n(n({}, r), {}, { element: g }), !0),
          g.setAttribute("stroke", l ? "url(#linear-".concat(i, ")") : u);
        var v = d
          ? ""
          : "border-radius:50%;box-shadow:inset 0px 0px "
              .concat(a, "px ")
              .concat(a, "px ")
              .concat(o.hex2rgb(u, p));
        t.setAttribute(
          "style",
          "width:"
            .concat(f, "px;height:")
            .concat(f, "px;position:relative;")
            .concat(v)
        );
      }),
      e(this, "animationTo", function (e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
          ...
          c = document.querySelector(
            ".".concat(o.pieName, "-circle-").concat(e.index)
          );
        if (c) {
          var a = JSON.parse(c.getAttribute("data-angel")),
            s = t ? e : n(n({}, r), e),
            l = document.querySelector(
              ".".concat(o.pieName, "-percent-").concat(e.index)
            );
          if (!(i > 100 || i < 0 || a === i)) {
            var u,
              d = t ? 0 : a,
              p = function e() {
                a >= s.percent ? d-- : d++,
                  ...
                  d === i &&
                    (c.setAttribute("data-angel", d), cancelAnimationFrame(u));
              };
      ...
      e(this, "percentElement", function (e) {
        var t = e.index,
          ...
          i = e.fontColor;
        return '<text class="'
          .concat(o.pieName, "-percent-")
          .concat(t, '" x="50%" y="50%" font-size="')
          .concat(n, '" font-weight="')
          .concat(r, '" fill="')
          .concat(i, '" text-anchor="middle" dominant-baseline="central" />');
      }),
      ...
      e(this, "circleSvg", function (e, t) {
        var r = e.index,
          ...
          l = { fill: "none", stroke: i, strokeWidth: c },
          u =
            "top" === t
