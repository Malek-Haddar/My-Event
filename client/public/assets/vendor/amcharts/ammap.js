...
(function () {
  ...
  d.AmDraw = d.Class({
    ...
    rect: function (a, b, c, e, g, f, k) {
      ...
      1 > c && (c = 1);
      1 > e && (e = 1);
      h.attr({ x: a, y: b, width: c, height: e, rx: g, ry: g, strokeWidth: f });
  ...
  d.AmLegend = d.Class({
    ...
    createX: function () {
      var a = (this.markerSize - 4) / 2,
        b = { stroke: this.switchColor, strokeWidth: 3 },
        c = this.container,
    ...
    rescaleObjects: function () {
      ...
      if ((e = b.linesToResize))
        for (c = 0; c < e.length; c++)
          (d = e[c]), d.line.setAttr("strokeWidth", d.thickness / a);
      b = b.objectsToResize;
      for (c = 0; c < b.length; c++)
    ...
    selectObject: function (a, b) {
      ...
      if (e) {
        if (
          ...
          void 0 !== h && e.setAttr("strokeWidth", h);
      ...
      if (!a.showAsSelected && b && !a.isOver) {
        ...
        "MapImage" == a.objectType
          ? ((c = this.imagesSettings.rollOverOutlineThickness),
            (e = a.image) && (isNaN(c) || e.setAttr("strokeWidth", c)))
          : ((c = this.areasSettings.rollOverOutlineThickness),
            isNaN(c) || b.setAttr("strokeWidth", c));
        if ("MapArea" == a.objectType) {
          ...
          isNaN(g) || b.setAttr("strokeWidth", g / e);
