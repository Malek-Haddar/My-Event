    ...
    (this.type = this.element.is("[type=checkbox]")
      ...
      "checkbox" === this.type || "radio" === this.type
        ? ((e = this.element.parents().last()),
          (t = "label[htmlFor='" + this.element.attr("id") + "']"),
...
e.extend(n.prototype, {
  ...
  _checkOffset: function (t, i, s) {
    ...
    return (
      ...
      (i.top -=
        s && i.top === t.input.offset().top + r ? e(document).scrollTop() : 0),
      (i.left -= Math.min(
        i.left,
    ...
    _mouseCapture: function (t) {
      ...
      return this.helper ||
        ...
        : ((this.handle = this._getHandle(t)),
          this.handle
            ? (e(s.iframeFix === !0 ? "iframe" : s.iframeFix).each(function () {
                e(
        ...
        (h = s.snapElements[c].left),
          ...
          !e.contains(
            ...
            : ("inner" !== f.snapMode &&
                ...
                a &&
                  (i.position.top =
                    s._convertPositionTo("relative", { top: d, left: 0 }).top -
                    s.margins.top),
                o &&
                  (i.position.left =
                    s._convertPositionTo("relative", {
                ...
                r &&
                  (i.position.left =
                    s._convertPositionTo("relative", { top: 0, left: l }).left -
                    s.margins.left)),
              (p = n || a || o || r),
              "outer" !== f.snapMode &&
                ((n = m >= Math.abs(u - y)),
                ...
                n &&
                  (i.position.top =
                    s._convertPositionTo("relative", { top: u, left: 0 }).top -
                    s.margins.top),
                a &&
                  (i.position.top =
                    s._convertPositionTo("relative", {
                ...
                o &&
                  (i.position.left =
                    s._convertPositionTo("relative", { top: 0, left: h }).left -
                    s.margins.left),
                r &&
                  (i.position.left =
                    s._convertPositionTo("relative", {
...
(e.effects = { effect: {} }),
  ...
  e.widget("ui.selectmenu", {
    ...
    _drawButton: function () {
      ...
      (this.label = e("label[htmlFor='" + this.ids.element + "']").attr(
        "for",
        this.ids.button
      )),
        this._on(this.label, {
