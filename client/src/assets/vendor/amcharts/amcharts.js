...
d.Class({construct:function(){}});d.GraphDataItem=d.Class({construct:function(){}});d.Guide=d.Class({construct:function(a){this.cname="Guide";d.applyTheme(this,a,this.cname)}});d.Title=d.Class({construct:function(a){this.cname="Title";d.applyTheme(this,a,this.cname)}});d.Label=d.Class({construct:function(a){this.cname="Label";d.applyTheme(this,a,this.cname)}})})();(function () {
  ...
  d.AmGraph = d.Class({
    ...
    drawLineGraph: function (a, b, c, e) {
      ...
      if (1 < a.length) {
        ...
        q.node.setAttribute("strokeLinejoin", "round");
        ...
        void 0 === z ||
          ...
          p.node.setAttribute("strokeLinejoin", "round"),
...
(function () {
  ...
  d.Bezier = d.Class({
    construct: function (a, b, c, e, g, f, h, k, l, m, n) {
      ...
      0 === k && (h = "none");
      f = { fill: h, "fill-opacity": k, strokeWidth: f };
...
(function () {
  ...
  d.AmDraw = d.Class({
    ...
    rect: function (a, b, c, e, g, f, h) {
      ...
      1 > c && (c = 1);
      1 > e && (e = 1);
      k.attr({ x: a, y: b, width: c, height: e, rx: g, ry: g, strokeWidth: f });
