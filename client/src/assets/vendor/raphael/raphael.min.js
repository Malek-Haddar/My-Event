                ...
                for (var s = 1; s < r + 1; s++)
                  n.push(
                    i.path(a).attr({
                      ...
                      strokeLinecap: "round",
                      strokeWidth: +((e.width / r) * s).toFixed(3),
              ...
              var x = function (i, n) {
                        ...
                        : ((M = x(x("marker"), {
                          ...
                          (A = x(x("use"), {
                            ...
                            transform:
                              ...
                              B / C +
                              ")",
                            strokeWidth: (1 / ((k / C + B / C) / 2)).toFixed(4),
                          })),
                          M.appendChild(A),
                ...
                w = function (t, e, i) {
                  if ((e = _[r(e).toLowerCase()])) {
                    for (
                      var n = t.attrs["strokeWidth"] || "1",
                        a =
                          { round: n, square: n, butt: 0 }[
                            t.attrs["strokeLinecap"] || i["strokeLinecap"]
                          ] || 0,
                        s = [],
                        o = e.length;
                      o--;
              ...
              (S.prototype = T),
                ...
                (T.transform = function (r) {
                  ...
                  if (
                    ...
                    var n = this.attrs[e]("strokeWidth")
                      ? this.attrs["strokeWidth"]
                      : 1;
                    this.attr({ strokeWidth: n });
                  }
                  return this;
                }),
                (T.hide = function () {
                ...
                (t._engine.setViewBox = function (t, e, r, i, n) {
                  ...
                  for (
                    ...
                    (o = "strokeWidth" in c.attrs ? c.attrs["strokeWidth"] : 1),
                      c.attr({ strokeWidth: o }),
                      (c._.dirty = 1),
                      (c._.dirtyT = 1),
                      (c = c.prev);
                ...
                C = function (n, l) {
                  ...
                  if (
                    ...
                    null != l.opacity ||
                      ...
                      null != l["strokeLinejoin"] ||
                      null != l["strokeLinecap"])
                  ) {
                    ...
                    O.on && l.stroke && (O.color = W.hex),
                      (q =
                        ...
                        ((+g.opacity + 1 || 2) - 1) *
                        ((+W.o + 1 || 2) - 1));
                    var Y = 0.75 * (i(l["strokeWidth"]) || 1);
                    if (
                      ((q = o(s(q, 0), 1)),
                      null == l["strokeWidth"] && (Y = g["strokeWidth"]),
                      l["strokeWidth"] && (O.weight = Y),
                      Y && Y < 1 && (q *= Y) && (O.weight = 1),
                      (O.opacity = q),
                      l["strokeLinejoin"] &&
                        (O.joinstyle = l["strokeLinejoin"] || "miter"),
                      (O.miterlimit = l["stroke-miterlimit"] || 8),
                      l["strokeLinecap"] &&
                        (O.endcap =
                          "butt" == l["strokeLinecap"]
                            ? "flat"
                            : "square" == l["strokeLinecap"]
                            ? "square"
                            : "round"),
